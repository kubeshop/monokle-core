 ...
 */
export function implicitNamespaceMatcher(sourceResource: Resource, targetResource: Resource) {
 ...
 */
export const optionalExplicitNamespaceMatcher: SiblingMatcher = (source, target, value) => {
  if (value) {
...
export const explicitNamespaceMatcher: SiblingMatcher = (_source, target, value) => {
  return target.namespace === value;
};
 ...
 */
export const targetGroupMatcher: SiblingMatcher = (source, target, value, siblingValues, properties) => {
