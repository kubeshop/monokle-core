      ...
      {topic === 'explore' && (
        <WalkThroughCard
          ...
          items={[
            ...
            <S.Slice>
              <S.SubHeading>2. Preview Helm charts & Kustomization</S.SubHeading>
              <S.Text>
        ...
        <WalkThroughCard
          ...
          items={[
            <S.Slice>
              ...
              <S.Text>
                <S.Text $bold>Use code or forms indistinctly.</S.Text> Jump from one to another anytime to see changes.
              </S.Text>
              <S.Text>
            ...
            <S.Slice>
              ...
              <S.Text>You can promote, deploy or commit changes made, or take to local anything published.</S.Text>
            </S.Slice>,
          ]}
        />
      )}
        ...
        <WalkThroughCard
          ...
          items={[
            <S.Slice>
              ...
              <S.Text>
                <S.Text $bold>Activate OPA rules </S.Text>based on your policy or preferences, severity etc. Set it all
                up in
                <S.SettingOutlinedIcon />
              </S.Text>

              <S.Text>
                <S.Text $bold>Check schema version.</S.Text> Make sure you have your desired K8s schema version on. Find
        ...
        <WalkThroughCard
          ...
          items={[
            <S.Slice>
              ...
              <S.Text>Take your changes management into the Git workflow - for any project. You can:</S.Text>
              <ul>
                <li>
                  <S.Text>
                    <S.Text $bold>Get your local files to git</S.Text> with 1 click.
                  </S.Text>
                </li>
                <li>
                  <S.Text>
                ...
                <li>
                  <S.Text>
                    <S.Text $bold>Create PRs, commit, push, stage/unstage...</S.Text>
            ...
            <S.Slice>
              ...
              <S.Text>
                <S.Text $bold>Deploy </S.Text>any change or state of your resources to the cluster anytime.
              </S.Text>
              <S.Text>
                <S.Text $bold>Configure a different accent color </S.Text>for each one of your clusters for easier
                differentiation.
              </S.Text>
            </S.Slice>,
          ]}
