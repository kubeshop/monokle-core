            ...
            items={[
              <S.Slice>
                ...
                <S.Text>
                  ...
                  contained in it. Switch between them for different views.
                  Click on <S.MenuOutlinedIcon /> to change project or create a
                  new one.
                </S.Text>
              </S.Slice>,
              ...
              <S.Slice>
                ...
                <S.Text>
                  ...
                  projects. Also, you can preview them, see & fix errors and
                  more.
                </S.Text>
              </S.Slice>,
          ...
          <WalkThroughCard
            ...
            items={[
              <S.Slice>
                ...
                <S.Text>
                  <S.Text $bold>Use code or forms indistinctly.</S.Text> Jump
                  from one to another anytime to see changes.
                </S.Text>
                <S.Text>
                  ...
                  <S.Icon
                    ...
                    $color={Colors.blue6}
                  />
                  to access a split screen with side-to-side code and form
                  views.
                </S.Text>
                <S.Text>
              ...
              <S.Slice>
                ...
                <S.Text>
                  Try this dedicated utility to compare resources that are at
                  any stage of the k8s lifecycle: local, cluster, previews, on
                  git...
                </S.Text>
                <S.Text>
                  You can promote, deploy or commit changes made, or take to
                  local anything published.
                </S.Text>
              </S.Slice>,
            ]}
          />
          ...
          <WalkThroughCard
            ...
            items={[
              <S.Slice>
                ...
                <S.Text>
                  <S.Text $bold>Check schema version.</S.Text> Make sure you
                  have your desired K8s schema version on. Find it always on the
                  top bar for quick switch.
                </S.Text>
              </S.Slice>,
